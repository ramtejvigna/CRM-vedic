...
import ViewCustomers from "./components/admin-dashboard/Customer/ViewCustomers"; 
import CustomerDetails from "./components/admin-dashboard/Customer/customerDetails"; // Import the CustomerDetails component
