            ...
            <Card className='flex flex-wrap p-6 gap-5 bg-white rounded-xl shadow-lg border'>
                ...
                <div className='flex flex-col p-2'>
                    <div className="rounded-md border flex p-3 items-center justify-between">
                        ...
                        <button onClick={() => setImage(`https://vedic-backend.netlify.app/${employee?.aadharOrPan}`)} className='bg-blue-400 px-3 p-1 text-white rounded-lg'>
                            view
                        </button>
                    </div>
                    <div className="rounded-md border flex p-3 items-center justify-between">
                        <span>passport</span>
                        <button onClick={() => setImage(`https://vedic-backend.netlify.app/${employee?.passport}`)} className='bg-blue-400 px-3 p-1 text-white rounded-lg'>
                            view
                        </button>
                    </div>
                    <div className="rounded-md border flex p-3 items-center justify-between">
                        <span>degrees</span>
                        <button onClick={() => setImage((prev) => prev = `https://vedic-backend.netlify.app/${employee?.degrees}`)} className='bg-blue-400 px-3 p-1 text-white rounded-lg'>
                            view
                        </button>
                    </div>
                    <div className="rounded-md border flex p-3 items-center justify-between">
                        <span>transcripts</span>
                        <button onClick={() => setImage(`https://vedic-backend.netlify.app/${employee?.transcripts}`)} className='bg-blue-400 px-3 p-1 text-white rounded-lg'>
                            view
                        </button>
                    </div>
                </div>
