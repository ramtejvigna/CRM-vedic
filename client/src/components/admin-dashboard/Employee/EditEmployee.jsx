                ...
                return (
                    ...
                    {!formData.idDocuments.aadharOrPan ? (
                        ...
                        <div className="mt-2 p-4 border-dashed border-2 border-gray-300 rounded-lg  bg-gray-50 flex items-center justify-center">
                            <img
                            src={( typeof formData.idDocuments.aadharOrPan === "string" ? `https://vedic-backend.netlify.app/${formData.idDocuments.aadharOrPan}` : URL.createObjectURL(formData.idDocuments.aadharOrPan))}
                            alt="Aadhar or Pan"
                    ...
                    {!formData.idDocuments.passport ? (
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="mt-2 p-4 border-dashed border-2 border-gray-300  rounded-lg bg-gray-50 flex items-center justify-center">
                                <img
                            src={( typeof formData.idDocuments.passport === "string" ? `https://vedic-backend.netlify.app/${formData.idDocuments.passport}` : URL.createObjectURL(formData.idDocuments.passport))}
            ...
            case 2:
                return (
                    ...
                    {!formData.education.degrees ? (
                        ...
                        <div className="mt-2 p-4 border-dashed border-2  border-gray-300 rounded-lg bg-gray-50 flex items-center justify-center">
                            <img
                            src={( typeof formData.education.degrees === "string" ? `https://vedic-backend.netlify.app/${formData.education.degrees}` : URL.createObjectURL(formData.education.degrees))}
                    ...
                    {!formData.education.transcripts ? (
                        ...
                        <div className="mt-2 p-4 border-dashed border-2  border-gray-300 rounded-lg bg-gray-50 flex items-center justify-center">
                            <img
                            src={( typeof formData.education.transcripts === "string" ? `https://vedic-backend.netlify.app/${formData.education.transcripts}` : URL.createObjectURL(formData.education.transcripts))}
                            alt="Transcripts"
                            className="h-64 object-cover"
                            />
                        </div>
