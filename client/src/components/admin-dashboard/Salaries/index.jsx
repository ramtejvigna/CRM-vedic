                ...
                >
                  <tr>
                    {["s no", "Employee name", "Amount paid", "year", "month", "Bank Statement", "Actions"].map((header) => (
                      <th
                        key={header}
                        className={`px-6 py-3 text-xs font-medium capitalize tracking-wider ${isDarkMode ? "text-gray-300" : "text-gray-700"
                          }`}
                        style={{
                        ...
                        >
                          ...
                          <td className="px-6  py-4 flex gap-3 flex-wrap whitespace-nowrap text-sm font-medium">
                            <button
                              ...
                              className={`mr-4 flex gap-3 items-center justify-center  transition-colors duration-300 ${isDarkMode
