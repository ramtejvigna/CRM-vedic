...
const BabyDatabase = () => {
    ...
    const fetchBabyNames = async () => {
        try {
            const response = await axios.get("https://vedic-backend.netlify.app/api/names");
    ...
    const handleCsvUpload = async (event) => {
        ...
        try {
            await axios.post("https://vedic-backend.netlify.app/uploadCsvNames", formData, {
    ...
    const saveEdit = async () => {
        try {
            await axios.put(`https://vedic-backend.netlify.app/updateBabyName/${editingName._id}`, editingName);
            setEditingName(null);
            fetchBabyNames();
