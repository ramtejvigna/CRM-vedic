...
export function Sidenav() {
  ...
  return (
    <motion.aside
      ...
      className="bg-white flex flex-col gap-10 overflow-auto m-5 rounded-lg shadow-xl p-3 px-5 md:static z-30 fixed top-0 left-0 bottom-0"
    >
      <Link to="/">
        <Typography className="font-bold text-center text-black p-2">
          Admin Dashboard
        </Typography>
      </Link>
