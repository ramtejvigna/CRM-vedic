...
export function DashBoardChart({ color, chart, title, description, footer, filter }) {
    ...
    return (
        <div className="relative flex flex-col items-center w-full">
            {/* Chart Card */}
            <Card
                className={`relative border border-blue-gray-100 shadow-lg w-full ${isDarkMode ? "bg-black text-white" : "bg-white"
                    }`}
            >
                {/* Filter Container */}
                {filter && (
...
DashBoardChart.displayName = "/src/widgets/charts/dashboard-chart.jsx";
